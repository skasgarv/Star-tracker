const Stars = [            
    "Andromeda;Almaak;2h4m;42.3°",
    "Andromeda;Alpheratz;0h8m;29.1°",
    "Andromeda;Mirach;1h10m;35.6°",
    "Aquila;Altair;19h51m;8.9°",
    "Aquila;Althalimain;19h6m;-4.9°",
    "Aquila;Deneb el Okab;19h5m;13.9°",
    "Aquila;Tarazed;19h46m;10.6°",
    "Aquarius;Sadalmelik;22h6m;-0.3°",
    "Aquarius;Sadalsuud;21h32m;-5.6°",
    "Aquarius;Skat;22h55m;-15.8°",
    ...
    let starArray
    Stars.forEach((star) => {
        starArray = star.split(";")
        rightAscension =starArray[2].split(/h|m/)
        starCollection.push({
            Constellation: starArray[0],
            Star: starArray[1],
            rightAscension: {h:rightAscension[0],m:rightAscension[1]},
            declination: starArray[3]
        })
    })

 module.exports = starCollection